//This is the instructions/start of the quiz

// let instructions = $('#instructions')
// let startGame = $('<button id="subBtn">Get Started</button>')
// instructions.text('Please select the following picutres that you connect with').append(startGame)
// hide(quiz);
